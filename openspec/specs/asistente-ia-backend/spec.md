# Capability: asistente-ia-backend

## Purpose

Proxy serverless (Lambda + API Gateway) a un LLM en Bedrock con `llms.txt` como única base de conocimiento, límites de costo (rate limit, caché, presupuesto) y respuestas acotadas al perfil, sin exponer llaves ni datos sensibles.
