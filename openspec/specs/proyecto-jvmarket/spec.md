...
- **AND** incluye el enlace en vivo **Live Demo** (storefront CloudFront). NO se expone públicamente el
  Swagger/`/docs` de la API (evita señalar superficie de ataque del e-commerce)
...
- **AND** `llms.txt` menciona el Live Demo para que el asistente IA lo pueda referir (sin URL del Swagger)
